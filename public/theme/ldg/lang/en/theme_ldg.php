...
$string['choosereadme'] = 'LDG is the platform theme. It is a child of Moove and applies the LDG design system: dark background, electric blue accent and the Inter typeface. Course sellers keep their own identity through the category theme and the storefront settings.';
...
$string['privacy:metadata'] = 'The LDG theme stores no personal data. The accessibility and dark mode preferences shown on screen belong to the Moove theme, which declares them itself.';
...
$string['themecustomizedby'] = 'This theme was customized by';
