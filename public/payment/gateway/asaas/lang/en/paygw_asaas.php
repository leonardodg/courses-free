...
$string['environmentheading_desc'] = 'Register this URL as the webhook in the Asaas panel, with the token below in the authentication field: <code>{$a}</code>';
...
$string['errornosite'] = 'This Asaas account has no website registered, and Asaas refuses to issue any charge with a return URL until one is set. Fill in the site under My Account > Information at Asaas, or turn off "Send the buyer back" in the gateway settings.';
