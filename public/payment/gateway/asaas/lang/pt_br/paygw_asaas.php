...
$string['environmentheading_desc'] = 'Cadastre esta URL como webhook no painel do Asaas, com o token abaixo no campo de autenticação: <code>{$a}</code>';
...
$string['errornosite'] = 'Esta conta Asaas não tem site cadastrado, e o Asaas recusa emitir qualquer cobrança com URL de retorno enquanto não houver um. Preencha o site em Minha Conta > Informações no Asaas, ou desligue "Trazer o aluno de volta" nas configurações do gateway.';
